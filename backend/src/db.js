...
export async function migrate() {
  ...
  // Control de avisos de vencimiento (guardan el premium_until al que ya se avisó, para no repetir).
  await q(`ALTER TABLE families ADD COLUMN IF NOT EXISTS premium_pre_notice TEXT;`);
  await q(`ALTER TABLE families ADD COLUMN IF NOT EXISTS premium_post_notice TEXT;`);
