...
const Cloud = {
  ...
  spaces()                        { return this.req('GET', '/api/spaces'); },
  switchSpace(familyId)           { return this.req('POST', '/api/family/switch', { familyId }); },
  createSpace()                   { return this.req('POST', '/api/family/create-space'); },
